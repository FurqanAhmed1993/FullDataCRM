<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Bank.aspx.cs" Inherits="Pages_Setup_Bank" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-2">
                                <div class="form-group">
                                    <label>Bank</label>
                                    <asp:TextBox ID="txtBankSearch" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-8 col-lg-10" style="margin-top: 10px">
                                        ...
                                        <asp:Repeater ID="rpt" runat="server" OnItemDataBound="rpt_ItemDataBound">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="hidden" runat="server" id="hdfBankId" class="hdfBankId" value='<%# Eval("BankId") %>' />
                                                        <input type="hidden" runat="server" id="hfBankName" class="hfName" value='<%# Eval("BankName") %>' />
        ...
        <div class="modal-dialog">
            <div class="modal-content animated">
                <div class="modal-header" style="padding-bottom: 9px; padding-top: 9px; text-align: center">
                    <h5 class="modal-title">Add / Update Bank</h5>
                </div>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <div class="modal-body">
                            <input type="hidden" id="hfBankId" runat="server" class="hfBankId" value="0" />
                            
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label class="mb-5">Bank Name</label>
                                        <span class="MandatoryValue">* </span>
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtBank" Text="*" ValidationGroup="Add" ForeColor="Red"></asp:RequiredFieldValidator>

                                        <asp:TextBox runat="server" ID="txtBank" CssClass="form-control txtBank" autocomplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
