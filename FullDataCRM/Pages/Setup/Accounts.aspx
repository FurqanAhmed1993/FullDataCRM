<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Accounts.aspx.cs" Inherits="Pages_Setup_Bank" %>
                        ...
                        <div class="row"> 
                            <div class="col-sm-12 col-md-3 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtAccountSearch" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-9 col-lg-10" style="margin-top: 10px">
                                        ...
                                        <asp:Repeater ID="rpt" runat="server" OnItemDataBound="rpt_ItemDataBound">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="hidden" runat="server" id="hdfAccountId" class="hdfAccountId" value='<%# Eval("AccountId") %>' />
                                                        <input type="hidden" runat="server" id="hdfAccountName" class="hdfAccountId" value='<%# Eval("AccountName") %>' />
        ...
        <div class="modal-dialog">
            <div class="modal-content animated">
                <div class="modal-header" style="padding-bottom: 9px; padding-top: 9px; text-align: center">
                    <h5 class="modal-title">Add / Update Accounts</h5>
                </div>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <div class="modal-body">
                            <input type="hidden" id="hfAccountId" runat="server" class="hfAccountId" value="0" />
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtAccountName" Text="*" ValidationGroup="Add" ForeColor="Red"></asp:RequiredFieldValidator>

                                        <asp:TextBox runat="server" ID="txtAccountName" CssClass="form-control txtAccountName" autocomplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
