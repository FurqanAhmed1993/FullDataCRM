<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="DispositionCallPlacement.aspx.cs" Inherits="Pages_Setup_DispositionCallPlacement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row heading-bg">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h5 class="txt-dark">Disposition Call Placement</h5>
        </div>
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-sm-12 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Disposition Call Placement</label>
                                    <asp:TextBox ID="txtDispCallSearch" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                </div>
                            </div>
                                        ...
                                        <asp:Repeater ID="rpt" runat="server" OnItemDataBound="rpt_ItemDataBound">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="hidden" runat="server" id="hdfDispositionId" class="hdfLeadStatusId" value='<%# Eval("Id") %>' />
                                                        <input type="hidden" runat="server" id="hdfDispositionCallName" class="hdfLeadStatusName" value='<%# Eval("DispositionCallName") %>' />
                                                         <input type="hidden" runat="server" id="hfIsActive" class="hfRoleId" value='<%# Eval("IsActive") %>' />
                                                        <%# Eval("DispositionCallName") %>
                                                    </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content animated">
                <div class="modal-header" style="padding-bottom: 9px; padding-top: 9px; text-align: center">
                    <h5 class="modal-title">Add / Update Disposition of call placement</h5>
                </div>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <div class="modal-body">
                            <input type="hidden" id="hfDispositionId" runat="server" class="hfDispositionId" value="0" />
                            
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label class="mb-5">Disposition of call placement</label>
                                        <span class="MandatoryValue">* </span>
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtDispCallPlacementName" Text="*" ValidationGroup="Add" ForeColor="Red"></asp:RequiredFieldValidator>

                                        <asp:TextBox runat="server" ID="txtDispCallPlacementName" CssClass="form-control txtDispCallPlacementName" autocomplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
