<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Chat.aspx.cs" Inherits="Pages_Chat" %>
                    ...
                    #chatframe #chatsidepanel #contacts ul {
                        ...
                        #chatframe #chatsidepanel #contacts ul li.contact {
                            ...
                            #chatframe #chatsidepanel #contacts ul li.contact:hover {
                                color: #8f181a;
                                background-color: rgb(143 24 26 / 5%);
    ...
    <script type="text/javascript">
        ...
        function registerEvents(chatHub) {
            ...
            $('#btnCreateGroup').click(function () {
                ...
                if ($('#txtgroupname').val() == '') { alert('Please Enter Group Name'); return false; }
                mkadmin = false;
                var fromuserid = $('#hdConnectionUserId').val();
                var d = new Date();
                ...
                if (typemessage == 'Group') {
                    ...
                    if (ConnectedUserID == TO_UserID && GroupID != 0) {
                        if ($("#tbl_chats").css('display') != 'block') {
                            ...
                            if ($("#lbl_chatbodyheadername").text() != 'Irfan' && $("#lbl_chatbodyheadername").text() == GroupName) {
                                ...
                                if (ConnectedUserID != From_User_ID && ConnectedUserID == TO_UserID) {
                                    alert('Message Recieved From ' + From_User_Name + ' In Group=> ' + GroupName);
                                }
                    ...
                    if (ConnectedUserID != From_User_ID && ConnectedUserID == TO_UserID && GroupID == 0) {
                        ...
                        if ($("#tbl_chats").css('display') != 'block') {
                            ...
                            debugger
                            if ($("#lbl_chatbodyheadername").text().trim() == 'Irfan') {
                                ...
                                if (ConnectedUserID != From_User_ID && ConnectedUserID == TO_UserID) {
                                    alert('Message Recieved From=> ' + From_User_Name);
                                }
                            }
                        }
                    }
        ...
        function AddList(ListID, ListName, ListDepartmentName) {
            ...
            var tbl_list = '';
            tbl_list += '<li class="contact" onclick="openchatmessage(' + "'" + ListID + "'" + "," + "'" + ListName + "'" + "," + "'" + ListDepartmentName + "'" + "," + "'" + typemessage + "'" + ');" >';
            tbl_list += '<div class="wrap">';
            tbl_list += '<div class="meta">';
            tbl_list += '<p class="name">' + ListName + '</p>';
            tbl_list += '<p class="preview">';
            tbl_list += ListDepartmentName
            tbl_list += '</p>';
            tbl_list += '</div>';
            tbl_list += '</div>';
            tbl_list += '</li>';
            ...
            if (ListDepartmentName != 'Group') {
                ...
                tbl_list_group += '<div style="text-align: left;font-size: 8px;">';
                tbl_list_group += ListDepartmentName
                tbl_list_group += '</div>';
                tbl_list_group += '</td>';
                tbl_list_group += '</tr>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div id="chatsidepanel">
                        <div id="profile">
                            <div class="wrap">
                                ...
                                <img src="../Assets/Images/Status/new-group.png" class="creategroup btn_AddItem1" data-bs-toggle="modal" data-bs-target="#creategroup" alt="" />
                            </div>
                        </div>
                        <div id="search">
                        ...
                        <div id="span9" style="display: none;">
                            <div id="chatbodyheader" class="chat-profile">
                                <div class="active-user-info">
                                    ...
                                    <h5><label id="lbl_chatbodyheadername" style="text-transform: capitalize; font-weight: 600;">Irfan</label></h5>
                                </div>
                                <div class="right-option">
                                    <img id="img_grp" src="../Assets/Images/Status/Icons/setting.png" style="display: none" class="myModal btn_AddItem" data-bs-toggle="modal" data-bs-target="#myModal" />
                                </div>
                            </div>
                            ...
                            <div id="chatbodyfooter" class="message-input">
                                <div class="wrap d-flex">
                                    ...
                                    <label class="file-upload">
                                        <i class="icon-upload" aria-hidden="true" style="font-size: 28px; color: #54656f; display: flex;">
    ...
    <%-- To Create Group --%>
    <div id="creategroup" class="modal fade" role="dialog" data-bs-keyboard="false" data-bs-backdrop="static">
                ...
                <ContentTemplate>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="board-widgets-head clearfix" style="height: 341px; overflow-y: scroll">
    ...
    <%-- For Setting --%>
    <div id="myModal" class="modal fade" role="dialog" data-bs-keyboard="false" FV="static">
                ...
                <ContentTemplate>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="board-widgets-head clearfix" style="border: solid; height: 341px; overflow-y: scroll">
